%==============================================
% WorldTheory.pl for actor caller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucaller).	%%old version (deprecated)
actorobj(qatucaller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor caller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of caller" ). 
...
%-------------------------------------------------
%  User static rules about caller
%------------------------------------------------- 
/*
------------------------------------------------------------------------
