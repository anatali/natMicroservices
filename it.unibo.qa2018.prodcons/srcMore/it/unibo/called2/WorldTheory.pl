%==============================================
% WorldTheory.pl for actor called2
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucalled2).	%%old version (deprecated)
actorobj(qatucalled2).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor called2
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of called2" ). 
...
%-------------------------------------------------
%  User static rules about called2
%------------------------------------------------- 
/*
------------------------------------------------------------------------
