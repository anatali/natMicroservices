%==============================================
% WorldTheory.pl for actor called1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucalled1).	%%old version (deprecated)
actorobj(qatucalled1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor called1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of called1" ). 
...
%-------------------------------------------------
%  User static rules about called1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
