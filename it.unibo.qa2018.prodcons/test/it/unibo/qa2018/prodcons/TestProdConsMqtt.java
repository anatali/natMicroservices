...
private Consumer consumer;
	...
	public void setUp(){  		
			System.out.println("================== setUp  ==================");
				try { 
					System.out.println("TestProdConsMqtt setUp STARTS producer="+producer   );
					it.unibo.ctxBasicProdConsMqtt.MainCtxBasicProdConsMqtt.initTheContext();
					...
					producer = (Producer) QActorUtils.getQActorForTesting("producer");
			 		...
			 		System.out.println("TestProdConsMqtt setUp ENDS producer="+producer   );
				} catch (Exception e) {
			 			fail( e.getMessage() ) ;
			 	}	
	}
