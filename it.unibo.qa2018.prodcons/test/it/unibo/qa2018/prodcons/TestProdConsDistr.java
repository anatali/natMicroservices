...
public class TestProdConsDistr {
...
private Consumer consumer;
	...
	protected void startProducer() {
		try { 
			...
			it.unibo.ctxBasicProdDistr.MainCtxBasicProdDistr.initTheContext();
	...
	protected void startConsumer() {
		try { 
			System.out.println("setUp STARTS consumer="+consumer   );
 			it.unibo.ctxBasicConsDistr.MainCtxBasicConsDistr.initTheContext();
