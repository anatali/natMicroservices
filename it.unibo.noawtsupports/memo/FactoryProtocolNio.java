...
public class FactoryProtocolNio extends SituatedPlainObject{
...
public static final String SERIAL = "SERIAL";
	...
	public FactoryProtocolNio(IOutputView outView, String protocol, String worker) {
		super(outView);
...
// 		println("FactoryProtocol CREATED for " + protocol);
	...
	public  IConnInteraction createSerialProtocolSupport(  
			String portName, SerialPortEventListener listener, boolean notifyOnDataAvailable  ) throws Exception{
// 		println("FactoryProtocol createSerialProtocolSupport for " + portName);
		...
		return factory.createSerialProtocolSupport(  portName, listener, notifyOnDataAvailable );		
	}
