...
private String logo = "sysServer";
private Socket socket;
private DataOutputStream outputChannel;
private BufferedReader inputChannel;

	public SocketTcpConnSupport(String logo, Socket socket, IBasicUniboEnv env) {
		super(env);
		init(logo,socket);
	}
	public SocketTcpConnSupport(String logo, Socket socket, IOutputView outView) {
		super(outView);
		init(logo,socket);
	}
	
	protected void init(String logo,Socket socket){
