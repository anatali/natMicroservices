package it.unibo.supports.tcp.nio;
...
public class FactoryTcpNioProtocol extends FactoryProtocol{
private SocketTcpSupport tcpSupport ;
	
	public FactoryTcpNioProtocol(IOutputView outView, String worker ){
